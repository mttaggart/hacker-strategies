...
class Parcel {
  ...
  async _init() {
    ...
    _classPrivateFieldSet(this, _bundlerRunner, new (_BundlerRunner().default)({
      ...
      requestTracker: _classPrivateFieldGet(this, _requestTracker),
  ...
  async _build({
    ...
    try {
      ...
      let {
        ...
        force: options.shouldBuildLazily && _classPrivateFieldGet(this, _requestedAssetIds).size > 0
      });

      _classPrivateFieldGet(this, _requestedAssetIds).clear();

      let [bundleGraph, serializedBundleGraph // $FlowFixMe[incompatible-call] Due to dumpGraphToGraphViz usage below
      ] = await _classPrivateFieldGet(this, _bundlerRunner).bundle(assetGraph, {
        signal
      });
      ...
      (0, _utils().assertSignalNotAborted)(signal); // $FlowFixMe

...
async function resolveOptions(initialOptions) {
  var _initialOptions$mode, _initialOptions$defau, _initialOptions$defau2, _initialOptions$defau3, _initialOptions$defau4, _initialOptions$defau5, _initialOptions$defau6, _initialOptions$shoul, _initialOptions$shoul2, _initialOptions$shoul3, _initialOptions$env, _initialOptions$shoul4, _initialOptions$hmrOp, _initialOptions$shoul5, _initialOptions$shoul6, _initialOptions$logLe, _initialOptions$addit, _initialOptions$defau7, _initialOptions$defau8, _initialOptions$defau9, _initialOptions$defau10, _initialOptions$defau11;
  ...
  return {
    ...
    shouldPatchConsole: (_initialOptions$shoul3 = initialOptions.shouldPatchConsole) !== null && _initialOptions$shoul3 !== void 0 ? _initialOptions$shoul3 : process.env.NODE_ENV !== 'test',
    env: { ...process.env,
      ...initialOptions.env,
    ...
    cache,
    packageManager,
    additionalReporters: (_initialOptions$addit = initialOptions.additionalReporters) !== null && _initialOptions$addit !== void 0 ? _initialOptions$addit : [],
    instanceId: generateInstanceId(entries),
    detailedReport: initialOptions.detailedReport,
    defaultTargetOptions: {
      shouldOptimize,
      shouldScopeHoist: (_initialOptions$defau7 = initialOptions === null || initialOptions === void 0 ? void 0 : (_initialOptions$defau8 = initialOptions.defaultTargetOptions) === null || _initialOptions$defau8 === void 0 ? void 0 : _initialOptions$defau8.shouldScopeHoist) !== null && _initialOptions$defau7 !== void 0 ? _initialOptions$defau7 : initialOptions.mode === 'production',
      sourceMaps: (_initialOptions$defau9 = initialOptions === null || initialOptions === void 0 ? void 0 : (_initialOptions$defau10 = initialOptions.defaultTargetOptions) === null || _initialOptions$defau10 === void 0 ? void 0 : _initialOptions$defau10.sourceMaps) !== null && _initialOptions$defau9 !== void 0 ? _initialOptions$defau9 : true,
      publicUrl,
      distDir,
      engines: initialOptions === null || initialOptions === void 0 ? void 0 : (_initialOptions$defau11 = initialOptions.defaultTargetOptions) === null || _initialOptions$defau11 === void 0 ? void 0 : _initialOptions$defau11.engines
    }
  };
}
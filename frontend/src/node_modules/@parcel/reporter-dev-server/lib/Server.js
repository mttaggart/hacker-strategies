...
class Server {
  constructor(options) {
    ...
    _defineProperty(this, "requestBundle", void 0);
  ...
  sendIndex(req, res) {
    if (this.bundleGraph) {
      ...
      let indexFilePath = htmlBundleFilePaths.length > 1 ? htmlBundleFilePaths.sort((a, b) => {
        ...
        return _path().default.basename(f).startsWith('index');
      }) : htmlBundleFilePaths[0];

      if (indexFilePath) {
        req.url = `/${_path().default.relative(this.options.distDir, indexFilePath)}`;

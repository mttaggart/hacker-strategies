    ...
    case 'buildStart':
      {
        ...
        if (options.serveOptions) {
          ...
          (0, _render().persistMessage)(_chalk().default.blue.bold(`${emoji().info} Server running at ${options.serveOptions.https ? 'https' : 'http'}://${(_options$serveOptions = options.serveOptions.host) !== null && _options$serveOptions !== void 0 ? _options$serveOptions : 'localhost'}:${options.serveOptions.port}`));
        }

...
var _default = new (_plugin().Namer)({
  name({
    ...
    let name = nameFromContent(mainBundle, bundleGroup.entryAssetId, options.entryRoot);
...
function nameFromContent(bundle, entryAssetId, entryRoot) {
  ...
  if (bundle.isEntry) {
    ...
    return _path().default.join(_path().default.relative(entryRoot, _path().default.dirname(entryFilePath)), name).replace(/\.\.(\/|\\)/g, '__$1');
  } else {

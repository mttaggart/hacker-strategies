...
function _JSONParseStream() {
  const data = _interopRequireDefault(require("./JSONParseStream"));

  _JSONParseStream = function () {
    return data;
  };
...
function _promiseFromProcess() {
  const data = _interopRequireDefault(require("./promiseFromProcess"));

  _promiseFromProcess = function () {
    return data;
  };

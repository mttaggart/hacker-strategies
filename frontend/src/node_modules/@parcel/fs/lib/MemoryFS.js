...
class MemoryFS {
  constructor(workerFarm) {
    ...
    _defineProperty(this, "_numWorkerInstances", 0);

    _defineProperty(this, "_workerHandles", void 0);

    _defineProperty(this, "_workerRegisterResolves", []);

    _defineProperty(this, "_emitter", new (_events().default)());
  ...
  findAncestorFile(fileNames, fromDir) {
    return (0, _find().findAncestorFile)(this, fileNames, fromDir);
  }
...
class Dirent {
  ...
  isSymbolicLink() {
    return Boolean(_classPrivateFieldGet(this, _mode) & S_IFLNK);
  }

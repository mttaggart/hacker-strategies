...
function searchJS() {
  const data = _interopRequireWildcard(require("./find"));
...
class NodeFS {
  constructor() {
    _defineProperty(this, "readFile", (0, _util().promisify)(_gracefulFs().default.readFile));

    _defineProperty(this, "copyFile", (0, _util().promisify)(_gracefulFs().default.copyFile));

    _defineProperty(this, "stat", (0, _util().promisify)(_gracefulFs().default.stat));

    _defineProperty(this, "readdir", (0, _util().promisify)(_gracefulFs().default.readdir));

    _defineProperty(this, "unlink", (0, _util().promisify)(_gracefulFs().default.unlink));

    _defineProperty(this, "utimes", (0, _util().promisify)(_gracefulFs().default.utimes));

    _defineProperty(this, "mkdirp", (0, _util().promisify)(_mkdirp().default));

    _defineProperty(this, "rimraf", (0, _util().promisify)(_rimraf().default));

    _defineProperty(this, "ncp", (0, _util().promisify)(_ncp().default));
    ...
    _defineProperty(this, "realpathSync", process.platform === 'win32' ? _gracefulFs().default.realpathSync : _gracefulFs().default.realpathSync.native);
    ...
    _defineProperty(this, "findAncestorFile", isPnP ? (...args) => searchJS().findAncestorFile(this, ...args) : searchNative().findAncestorFile);

    _defineProperty(this, "findNodeModule", isPnP ? (...args) => searchJS().findNodeModule(this, ...args) : searchNative().findNodeModule);

    _defineProperty(this, "findFirstFile", isPnP ? (...args) => searchJS().findFirstFile(this, ...args) : searchNative().findFirstFile);
  }

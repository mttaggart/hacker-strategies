...
var _default = new (_plugin().Packager)({
  async package({
    ...
    let posthtmlConfig = await asset.getConfig(['.posthtmlrc', '.posthtmlrc.js', 'posthtml.config.js'], {
      packageKey: 'posthtml'
    });
    let renderConfig = posthtmlConfig === null || posthtmlConfig === void 0 ? void 0 : posthtmlConfig.render;
    let {
      html

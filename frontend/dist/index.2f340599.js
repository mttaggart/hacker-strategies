...
})({"16Lt8":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "d8accf6481e0a87b9649d68c2f340599";
// @flow
...
},{}],"5Qvcc":[function(require,module,exports) {
var _hyperapp = require("hyperapp");
var _hyperappFx = require("hyperapp-fx");
const API_URL = "http://localhost:3000/api/";
const FetchCard = (state, e) => [state, _hyperappFx.Http({
...
const ButtonContainer = buttons => _hyperapp.h("div", {
  className: "button-container"
}, buttons);
const Footer = () => _hyperapp.h("footer", {}, [_hyperapp.h("p", {}, [_hyperapp.text("Inspiration for when you're stuck")]), _hyperapp.h("p", {}, [_hyperapp.text("Inspired by Brian Eno's "), _hyperapp.h("a", {
  href: "https://en.wikipedia.org/wiki/Oblique_Strategies"
}, _hyperapp.text("Oblique Strategies"))]), _hyperapp.h("p", {}, [_hyperapp.text("Made with 💙 by "), _hyperapp.h("a", {
  href: "https://taggart-tech.com"
}, _hyperapp.text("Taggart Tech"))])]);
_hyperapp.app({
  init: {
  ...
  view: ({currentCard}) => _hyperapp.h("main", {}, [_hyperapp.h("h1", {
    className: "headline"
  }, _hyperapp.text("Hacker Strategies")), CardDiv(currentCard), ButtonContainer([CardButton("red", "Red Team", "red-team"), CardButton("blue", "Blue Team", "blue-team")]), Footer()]),
...
},{}]},["16Lt8","5Qvcc"], "5Qvcc", "parcelRequiread31")

//# sourceMappingURL=index.2f340599.js.map
